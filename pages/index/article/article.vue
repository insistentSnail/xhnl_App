<template>
	<view class="articleView">
		<view class="list">
			...
			<input type="text" autocomplete="off" placeholder="请填写文章标题(不超过14个字)" v-model="title"  class="uni-input fl" />
		</view>
		...
		<view class="list" style="height:auto;min-height:80rpx;">
			...
			<textarea class="textarea" maxlength="200" placeholder="请输入描述" @blur="bindTextAreaBlur" :value="info" auto-height />
		</view>
